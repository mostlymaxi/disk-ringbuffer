...
pub const QUEUE_SIZE: u32 = 131072000;
pub const READ_ERROR: i32 = -1;
pub const VALUE_TERM_BYTE: u32 = 255;
pub const READ_SUCCESS: u32 = 0;
pub const READ_FINISHED: u32 = 1;
pub const READ_EMPTY: u32 = 2;
pub const WRITE_PAGE_FULL: u32 = 0;
...
pub const QUEUE_MAGIC_NUM: usize = 72057594037927936;
pub const QUEUE_MAGIC_MASK: usize = 72057594037927935;
#[repr(C)]
#[derive(Debug, Copy, Clone)]
pub struct CSlice {
    pub len: usize,
    pub ptr: *mut ::std::os::raw::c_uchar,
    pub read_status: ::std::os::raw::c_int,
}
#[test]
fn bindgen_test_layout_CSlice() {
    const UNINIT: ::std::mem::MaybeUninit<CSlice> = ::std::mem::MaybeUninit::uninit();
    let ptr = UNINIT.as_ptr();
    assert_eq!(
        ::std::mem::size_of::<CSlice>(),
        24usize,
        concat!("Size of: ", stringify!(CSlice))
    );
    assert_eq!(
        ::std::mem::align_of::<CSlice>(),
        8usize,
        concat!("Alignment of ", stringify!(CSlice))
    );
    assert_eq!(
    ...
    assert_eq!(
        unsafe { ::std::ptr::addr_of!((*ptr).read_status) as usize - ptr as usize },
        16usize,
        concat!(
            "Offset of field: ",
            stringify!(CSlice),
            "::",
            stringify!(read_status)
        )
    );
}
#[repr(C)]
#[derive(Debug, Copy, Clone)]
pub struct RawQPage {
    pub is_ready: atomic_size_t,
    pub write_idx_lock: atomic_size_t,
    pub last_safe_write_idx: atomic_size_t,
    pub buf: [::std::os::raw::c_uchar; 131072000usize],
}
#[test]
fn bindgen_test_layout_RawQPage() {
    const UNINIT: ::std::mem::MaybeUninit<RawQPage> = ::std::mem::MaybeUninit::uninit();
    let ptr = UNINIT.as_ptr();
    assert_eq!(
        ::std::mem::size_of::<RawQPage>(),
        131072024usize,
        concat!("Size of: ", stringify!(RawQPage))
    );
    assert_eq!(
        ::std::mem::align_of::<RawQPage>(),
        8usize,
        concat!("Alignment of ", stringify!(RawQPage))
    );
    assert_eq!(
        unsafe { ::std::ptr::addr_of!((*ptr).is_ready) as usize - ptr as usize },
        0usize,
        concat!(
            "Offset of field: ",
            stringify!(RawQPage),
    ...
    assert_eq!(
        unsafe { ::std::ptr::addr_of!((*ptr).write_idx_lock) as usize - ptr as usize },
        8usize,
        concat!(
            "Offset of field: ",
            stringify!(RawQPage),
            "::",
            stringify!(write_idx_lock)
        )
    );
    assert_eq!(
        unsafe { ::std::ptr::addr_of!((*ptr).last_safe_write_idx) as usize - ptr as usize },
        16usize,
        concat!(
            "Offset of field: ",
            stringify!(RawQPage),
            "::",
            stringify!(last_safe_write_idx)
        )
    );
    assert_eq!(
...
extern "C" {
    pub fn raw_qpage_new(path: *mut ::std::os::raw::c_char) -> *mut RawQPage;
}
extern "C" {
    pub fn raw_qpage_new_rs(path: *const ::std::os::raw::c_uchar, path_len: usize)
        -> *mut RawQPage;
}
extern "C" {
    pub fn raw_qpage_push_fast_read(
        p: *mut RawQPage,
...
extern "C" {
    pub fn raw_qpage_pop_fast_read(p: *mut RawQPage, start_byte: usize) -> CSlice;
}
extern "C" {
    pub fn _get_write_idx_spin(p: *mut RawQPage, start_byte: usize) -> usize;
}
extern "C" {
    pub fn raw_qpage_pop(p: *mut RawQPage, start_byte: usize) -> CSlice;
}
extern "C" {
    pub fn raw_qpage_drop(p: *mut RawQPage);
}
